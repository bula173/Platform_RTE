 ...
 *         RTE_STATUS_NOT_SUPPORTED if the backend cannot perform a
...
/*
 * The backend vtable (rte_reboot_backend_t) and
 * rte_reboot_register_backend() live in
 * safeapi_backend/reboot/rte_reboot_backend.h, not here (ADR-021). This
