 ...
 * REQ-COMMON-CAST-004: sapi_cast_checked_add_u32()/_sub_u32()/_mul_u32() and
 *                      the size_t equivalents shall detect overflow/
 *                      underflow and yield SAPI_STATUS_VALUE_OUT_OF_RANGE
 *                      instead of wrapping silently; *out is left untouched
 *                      on failure, same as every other function here
 *                      (REQ-COMMON-CAST-001).
 * REQ-COMMON-CAST-005: sapi_cast_bounds_check(index, count) shall return
 *                      SAPI_STATUS_OK if index < count, else
 *                      SAPI_STATUS_VALUE_OUT_OF_RANGE - a single checked
 ...
 * @return SAPI_STATUS_OK on success; SAPI_STATUS_INVALID_PARAM if out is
 *         NULL; SAPI_STATUS_VALUE_OUT_OF_RANGE if a + b overflows uint32_t
 *         (REQ-COMMON-CAST-004).
 */
 ...
 *             Must not be NULL.
 * @return SAPI_STATUS_OK on success; SAPI_STATUS_INVALID_PARAM if out is
 *         NULL; SAPI_STATUS_VALUE_OUT_OF_RANGE if b > a
 *         (REQ-COMMON-CAST-004).
 */
 ...
 *             Must not be NULL.
 * @return SAPI_STATUS_OK on success; SAPI_STATUS_INVALID_PARAM if out is
 *         NULL; SAPI_STATUS_VALUE_OUT_OF_RANGE if a + b overflows size_t
 *         (REQ-COMMON-CAST-004).
 */
 ...
 *              index is ever valid).
 * @return SAPI_STATUS_OK if index < count; SAPI_STATUS_VALUE_OUT_OF_RANGE
 *         otherwise (REQ-COMMON-CAST-005). Never SAPI_STATUS_INVALID_PARAM -
