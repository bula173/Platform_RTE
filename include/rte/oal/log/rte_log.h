...
#include "rte/utils/string/rte_string.h" /* rte_log_fields_t backing store */
 ...
 *       `rte::string`'s bounded helpers (`rte_string_concat()` etc.),
 ...
 * live in rte_osadapter/log/rte_osadapter_log.h, not here (ADR-021).
