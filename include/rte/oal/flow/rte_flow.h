 ...
 * (rte_osadapter/flow/rte_osadapter_flow.h) so a POSIX/TCP OSAdapter can
 ...
 * @{
 */
#ifndef RTE_OAL_FLOW_H
#define RTE_OAL_FLOW_H
...
RTE_DECLARE_STORAGE(rte_flow_storage_t, 64U);
 ...
 * rte_osadapter/flow/rte_osadapter_flow.h, not here (ADR-021 seam,
