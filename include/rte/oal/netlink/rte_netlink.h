 ...
 * @{
 */
#ifndef RTE_OS_NETLINK_H
#define RTE_OS_NETLINK_H
...
RTE_DECLARE_STORAGE(rte_netlink_storage_t, 64U);
 ...
 * rte_osadapter/netlink/rte_osadapter_netlink.h, not here (ADR-021). This
