...
@section types_architecture_overview C11 stdint.h Foundation
...
@section types_architecture_sizes Guaranteed Sizes
...
@section types_architecture_misra MISRA Compliance

✓ Rule 6.1 - Fixed-width types only
✓ Rule 7.2 - Proper signedness
✓ Rule 8.3 - Type compatible

@section types_architecture_see_also See Also
