# RTEHelpers.cmake
# Reusable CMake functions for projects using RteFramework
#
...
# Apply strict compiler warnings (matching RteFramework standards)
...
"{
  ...
  \"vendor\": {
    \"rte\": {
      \"description\": \"Presets based on RteFramework standards\"
    }
  },
  \"configurePresets\": [
    {
      \"name\": \"debug\",
      \"description\": \"Debug build with RteFramework\",
...
# Usage: rte_require_feature(RTE_ENABLE_WATCHDOG DEPENDS RTE_ENABLE_LOG RTE_ENABLE_TIMER)
function(rte_require_feature FEATURE_VAR)
...
# Verify that project follows RteFramework conventions
# Usage: rte_verify_conventions()
function(rte_verify_conventions)
  message(STATUS "Verifying RteFramework conventions...")

  # Check that C standard is set to at least C99
  if(NOT CMAKE_C_STANDARD)
    message(WARNING "CMAKE_C_STANDARD not set; RteFramework requires C99 or later")
  elseif(CMAKE_C_STANDARD LESS 99)
    message(WARNING "CMAKE_C_STANDARD is ${CMAKE_C_STANDARD}; RteFramework requires C99 or later")
  endif()
