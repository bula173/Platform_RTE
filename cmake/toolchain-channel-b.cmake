...
#       -DRTE_CHANNEL_BUILD_ID=B
#   cmake --build build-channel-b

find_program(RTE_CHANNEL_B_CLANG_COMPILER NAMES clang)
if(RTE_CHANNEL_B_CLANG_COMPILER)
    set(CMAKE_C_COMPILER "${RTE_CHANNEL_B_CLANG_COMPILER}" CACHE FILEPATH "Channel B C compiler")
    ...
    find_program(RTE_CHANNEL_B_GCC_COMPILER NAMES gcc)
    if(RTE_CHANNEL_B_GCC_COMPILER)
        set(CMAKE_C_COMPILER "${RTE_CHANNEL_B_GCC_COMPILER}" CACHE FILEPATH "Channel B C compiler (GCC fallback)")
    endif()
