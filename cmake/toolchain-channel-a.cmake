...
#       -DRTE_CHANNEL_BUILD_ID=A
#   cmake --build build-channel-a

find_program(RTE_CHANNEL_A_C_COMPILER NAMES gcc)
if(RTE_CHANNEL_A_C_COMPILER)
    set(CMAKE_C_COMPILER "${RTE_CHANNEL_A_C_COMPILER}" CACHE FILEPATH "Channel A C compiler")
else()
