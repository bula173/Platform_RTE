...
echo "     scp ${BUILD_DIR}/src/*/*.a target_user@qnx_target:/opt/app/lib/"
echo "     scp -r ${SCRIPT_DIR}/include/safeapi target_user@qnx_target:/opt/app/include/"
echo ""
echo "  2. In QNX application CMakeLists.txt:"
echo "     find_package(safeAPIFramework REQUIRED)"
echo "     target_link_libraries(my_app safeapi::timer safeapi::task ...)"
