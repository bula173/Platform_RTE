...
const char *rte_dual_state_to_string(rte_dual_state_t state)
{
    ...
    switch (state)
    {
        case RTE_DUAL_STATE_IDLE:
            result = "IDLE";
            break;
        case RTE_DUAL_STATE_UNKNOWN:
            result = "UNKNOWN";
            break;
        case RTE_DUAL_STATE_ONLINE:
            result = "ONLINE";
            break;
        case RTE_DUAL_STATE_HOTSTANDBY:
            result = "HOTSTANDBY";
            break;
        case RTE_DUAL_STATE_COLDSTANDBY:
            result = "COLDSTANDBY";
            break;
        default:
