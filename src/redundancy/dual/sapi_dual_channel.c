...
sapi_status_t sapi_dual_channel_send_heartbeat(sapi_dual_channel_t *channel, uint32_t *out_ack_link_count)
{
    ...
    /* sapi_dual_heartbeat_frame_t has a 4-byte compiler-inserted
     ...
     * sapi_dual_msgchannel_send() call below, since it hashes/sends
     ...
     * sapi_checksum_crc64(), reached from here. */
