...
sapi_status_t sapi_cast_checked_add_u32(uint32_t a, uint32_t b, uint32_t *out)
{
    ...
    if (widened > (uint64_t)UINT32_MAX)
    {
        sapi_safety_violation_report(SAPI_SAFETY_VIOLATION_OVERFLOW, __FILE__, (int32_t)__LINE__,
                                      "sapi_cast_checked_add_u32: addition overflowed uint32_t");
        return SAPI_STATUS_VALUE_OUT_OF_RANGE;
    }
...
sapi_status_t sapi_cast_checked_sub_u32(uint32_t a, uint32_t b, uint32_t *out)
{
    ...
    {
        sapi_safety_violation_report(SAPI_SAFETY_VIOLATION_OVERFLOW, __FILE__, (int32_t)__LINE__,
                                      "sapi_cast_checked_sub_u32: subtraction underflowed uint32_t");
        return SAPI_STATUS_VALUE_OUT_OF_RANGE;
    }
    *out = a - b;
    return SAPI_STATUS_OK;
...
sapi_status_t sapi_cast_checked_mul_u32(uint32_t a, uint32_t b, uint32_t *out)
{
    ...
    {
        sapi_safety_violation_report(SAPI_SAFETY_VIOLATION_OVERFLOW, __FILE__, (int32_t)__LINE__,
                                      "sapi_cast_checked_mul_u32: multiplication overflowed uint32_t");
        return SAPI_STATUS_VALUE_OUT_OF_RANGE;
    }
    *out = (uint32_t)widened;
    return SAPI_STATUS_OK;
...
sapi_status_t sapi_cast_checked_add_size(size_t a, size_t b, size_t *out)
{
    ...
    {
        sapi_safety_violation_report(SAPI_SAFETY_VIOLATION_OVERFLOW, __FILE__, (int32_t)__LINE__,
                                      "sapi_cast_checked_add_size: addition overflowed size_t");
        return SAPI_STATUS_VALUE_OUT_OF_RANGE;
    }
    *out = a + b;
    return SAPI_STATUS_OK;
...
sapi_status_t sapi_cast_checked_sub_size(size_t a, size_t b, size_t *out)
{
    ...
    {
        sapi_safety_violation_report(SAPI_SAFETY_VIOLATION_OVERFLOW, __FILE__, (int32_t)__LINE__,
                                      "sapi_cast_checked_sub_size: subtraction underflowed size_t");
        return SAPI_STATUS_VALUE_OUT_OF_RANGE;
    }
    *out = a - b;
    return SAPI_STATUS_OK;
...
sapi_status_t sapi_cast_checked_mul_size(size_t a, size_t b, size_t *out)
{
    ...
    {
        sapi_safety_violation_report(SAPI_SAFETY_VIOLATION_OVERFLOW, __FILE__, (int32_t)__LINE__,
                                      "sapi_cast_checked_mul_size: multiplication overflowed size_t");
        return SAPI_STATUS_VALUE_OUT_OF_RANGE;
    }
    *out = a * b;
    return SAPI_STATUS_OK;
...
sapi_status_t sapi_cast_bounds_check(size_t index, size_t count)
{
    if (index >= count)
    {
        sapi_safety_violation_report(SAPI_SAFETY_VIOLATION_OUT_OF_RANGE, __FILE__, (int32_t)__LINE__,
                                      "sapi_cast_bounds_check: index out of range");
        return SAPI_STATUS_VALUE_OUT_OF_RANGE;
    }
    return SAPI_STATUS_OK;
}
